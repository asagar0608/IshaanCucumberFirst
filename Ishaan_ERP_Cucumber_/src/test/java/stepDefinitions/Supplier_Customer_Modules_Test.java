...
public class Supplier_Customer_Modules_Test {
	...
	public void validate_Title_with(String Exp_Title) {
	  FunctionLibrary.validate_Title(Exp_Title);
	}
	...
	public void capture_Customer_number_with_and(String Ltype, String Lvalue) throws Throwable {
	   FunctionLibrary.captureCustomerNum(Ltype, Lvalue);
	}
